	...
	if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		add_action( 'admin_notices', function () {
			if ( current_user_can( 'activate_plugins' ) ) {
				echo '<div class="error message"><p><a href="https://wordpress.org/plugins/woocommerce/">Woocommerce</a> plugin must be active</p></div>';
			}
		} );

		return;
	} else {
		require_once get_template_directory() . '/woo-modules/FilmPostType.php';
		require_once get_template_directory() . '/woo-modules/WooFilm.php';
		require_once get_template_directory() . '/woo-modules/Authorization.php';
